...
Route::prefix('customer')->middleware(['auth:customer'])->name('customer.')->group(function () {
        ...
        Route::controller(\App\Http\Controllers\Customer\Dashboard::class)->group(function () {
            Route::get('/dashboard', 'index')->name('dashboard');
        });

        Route::controller(\App\Http\Controllers\BookingController::class)->prefix('booking')->name('bookings.')->group(function () {
